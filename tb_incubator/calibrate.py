...
def get_all_priors() -> List:
    ...
    priors = [
        ...
        esp.UniformPrior("screening_scaleup_shape", (0.01, 0.50)),
        esp.TruncNormalPrior("screening_inflection_time", 2010, 3.0, (2004, 2014)),
        esp.GammaPrior.from_mode("time_to_screening_end_asymp", 0.5, 3.0),
        #esp.UniformPrior("seed_time", (1840.0, 1900.0)),  
        #esp.UniformPrior("seed_duration", (1.0, 20.0)),
        #esp.UniformPrior("seed_rate", (1.0, 100.0)), 
        esp.BetaPrior.from_mean_and_ci("base_sensitivity", 0.45, (0.1, 0.80)),
        ...
        esp.UniformPrior("sustained_improvement", (1.0, 2.5)),
